...
public class PXCookieOriginalTokenValidatorTest {
    ...
    private String xAuthorizationToken = "3:25676dd757cb796e1b4252a4d395e7dbdd7b36787ac9d5c884a52b8cc3d79cd5:ZzY2AgkAS3Dhu6BVQAyn5XxQXQIuYLmnklh0gzPTsif/ItN+kQq46jyq0YPXYahfstf/r4V+mkexvyPl4KKLeA==:1000:AaIbjDjU8R1adPIPOum/L1q7WPzsizDk4g41ibYTDS8sPoKrEAnmOw6VTvpiC821l0MD4/Sn93wzE55/WPNJVBKnCADYHMY0Y3PQGDSLIPyaVybILJFMHX3FZjCc7uqW0yF/FX8L69ldxhBjXKx2Nc49kfLXwoSgS2dM3WTo6aC7CI8tj2DocKmmTm8Yg+ur";
    ...
    public void testPxCookieOriginalTokenValidatorWithOriginalToken(){
        ...
        enrichHttpRequestWithPxHeaders(request, Constants.MOBILE_SDK_ORIGINAL_TOKEN_HEADER, xAuthorizationToken);
        ...
        Assert.assertEquals(pxContext.getOriginalToken(), xAuthorizationToken);
        ...
        Assert.assertEquals(pxContext.getDecodedOriginalToken(),"{\"u\":\"484070ee-6783-44c8-86d1-2d9ca4a8eeb8\",\"v\":\"84f7db40-9592-11e8-a7b3-5319fb36a9bf\",\"t\":1533132216511,\"s\":0,\"a\":\"c\",\"sdk_version\":\"v1.5.4\"}");
    }
    ...
    public void testPxCookieOriginalTokenValidatorBadOriginalToken(){
        ...
        Assert.assertEquals(pxContext.getVid(),null);
        Assert.assertEquals(pxContext.getOriginalUuid(),null);
        Assert.assertEquals(pxContext.getDecodedOriginalToken(),null);
    }
