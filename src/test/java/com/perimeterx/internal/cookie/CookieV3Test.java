...
public class CookieV3Test {
    ...
    @Test
    public void testCookieV3FailOnNoCookie() throws PXException {
    ...
    @Test
    public void testCookieV3Pass() throws PXException {
    ...
    @Test
    public void testCookieV3FailOnSensitiveRoute() throws PXException {
    ...
    @Test
    public void testCookieV3FailOnDecryption() throws PXException {
    ...
    @Test
    public void testCookieV3FailOnFakeCookie() throws PXException {
    ...
    @Test
    public void testCookieV3FailOnCookieExpired() throws PXException {
    ...
    @Test
    public void testCookieV3PassAndHighScore() throws PXException {
    ...
    @Test
    public void testCookieV3PassLowScore() throws PXException {
        String pxCookie = "_px3=74c096e83d72f304bcae6d91b8017bb1e4a7c270f876ebc08977653c1b724714:LE+3eusyK6vE1d1pvI4t8HDnGQ0NCyr6aPLOIXXwT5Kr9WW1Ficr9WohnPZLdtZn/dHOsEz0fbk0YRYiKP+81g==:1000:GCTf15dR7qk+h8B+G7n3iI+1JCxiUajyAn+OJ4IRnaqMFE69CJ72+vG2m0qqQQhSF+Q13r1oVb0dgFqg0smfyA==";
        ((MockHttpServletRequest) request).addHeader("cookie", pxCookie);
        ((MockHttpServletRequest) request).addHeader("user-agent", "test_user_agent");
        this.context = new PXContext(request, ipProvider, hostnameProvider, pxConfiguration);
