...
public class MobileCookieHeaderParserTest {

    LoggerFactory loggerFactory = new LoggerFactory();
    private MobileCookieHeaderParser mobileCookieHeaderParser = new MobileCookieHeaderParser(loggerFactory.getRequestContextLogger());
